    ...
    render() {
        ...
        return <div>
            ...
            <div className="input-field">
                <div>Short name:</div>
                <input ref={this.shortNameInputRef} disabled={this.state.loading} autoFocus onKeyDown={(event) => event.key === "Enter" && this.titleInputRef.current.focus()} />
            </div>
            <div className="input-field">
                <div>Title:</div>
            ...
            <div className="buttons"><button disabled={this.state.loading} onClick={processCreatePage}>Create page</button></div>
