...
class Service extends Component {
    ...
    render() {
        const editHandler = () => {
            const updates = {};
            if (this.nameInputRef.current.value.trim() !== this.state.service.name)
                updates.name = this.nameInputRef.current.value.trim();
            if (this.typeSelectRef.current.value !== this.state.service.type)
                updates.type = this.typeSelectRef.current.value;
            if (this.hostInputRef.current.value.trim() !== this.state.service.host)
                updates.host = this.hostInputRef.current.value.trim();
            if (parseInt(this.protocolSelectRef.current.value) !== this.state.service.protocol)
                updates.protocol = parseInt(this.protocolSelectRef.current.value);
            if (this.alertInputRef.current.checked !== this.state.service.alert)
                updates.alert = this.alertInputRef.current.checked;
            if (this.disabledInputRef.current.checked !== this.state.service.disabled)
                updates.disabled = this.disabledInputRef.current.checked;
            ...
            updateService(this.state.service.id, updates)
                .then(() =>
                    this.setState({ loading: false, editing: false, service: { ...this.state.service, ...updates } })
                )
                .catch((error) => this.setState({ loading: false, info: error }));
        };
                    ...
                    <>
                        ...
                        <div className="input-field">
                            ...
                            <select
                                ...
                                defaultValue={this.state.service.type}
                                disabled={this.state.loading}
                            >
                        ...
                        <div className="input-field">
                            ...
                            <input
                                ...
                                defaultValue={this.state.service.host}
                                disabled={this.state.loading}
                        ...
                        <div className="input-field">
                            <div>Protocol:</div>
                            <select
                                ref={this.protocolSelectRef}
                                defaultValue={this.state.service.protocol}
                                disabled={this.state.loading}
                            >
                        ...
                        <div className="input-field">
                            <div>Alert:</div>
                            <input
                                ref={this.alertInputRef}
                                type="checkbox"
                                defaultChecked={this.state.service.alert}
                        ...
                        <div className="input-field">
                            <div>Disabled:</div>
                            <input
                                ref={this.disabledInputRef}
                                type="checkbox"
                                defaultChecked={this.state.service.disabled}
                                disabled={this.state.loading}
                            />
                        </div>
